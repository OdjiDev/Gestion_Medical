...
@endif
    ...
    <div class="col-md-3 text-end">
        <a class="btn bg-gradient-primary-custom text-white btn-sm" href="{{ route('vente.create') }}">
           <i class="fa fa-plus me-1"></i> Vente 
        </a>
    </div>
  ...
  <div class="card-body">
        ...
        <tbody>
            @foreach($vente as $vte)
                ...
                <td>
    {{ $vte->amo == 1 ? $vte->montant_payer : $vte->total }}
</td>
                  
                    <td>{{$vte->date}}</td>
                    <td>
                        <a type="button" class="btn btn-sm btn-info" href="{{route('vente.show',$vte->id)}}" ><i class="fa fa-eye "></i></a>
                        <a type="button" class="btn btn-sm btn-secondary" href="{{ route('ticket.show', $vte->id) }}" ><i class="fa fa-print "></i></a>
                        <a type="button" class="btn btn-sm btn-warning " href="/edit_items/{{$vte->id}}/edit" ><i class="fa fa-edit"></i></a>
                                            ...
                                            <div class="modal fade" id="staticBackdropdelete" data-bs-backdrop="static"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered ">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{route('vente.delete', $vte->id) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
