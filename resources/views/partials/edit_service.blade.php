            ...
            @method('PUT')
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="type_service" id="type_service" value="{{ old('type_service',$service->type_service) }}" 
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-text"><i class="fa fa-user"></i></span>
                        <input type="text" name="tarif" id="tarif" value="{{ old('tarif',$service->tarif) }}" 
