...
<div class="container my-5">
    <div class="card shadow-sm rounded-4 p-4">
        ...
        <h3 class="text-pr fw-bold mb-4 d-flex align-items-center">
            <i class="fa fa-user-edit me-2"></i> Modifier le Fournisseur
        </h3>
        ...
        <form action="{{ route('fournisseur.update', $fournisseur->id) }}" method="post">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="adresse" id="adresse" value="{{ old('adresse',$fournisseur->adresse ) }}" 
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="telephone" id="telephone" value="{{ old('telephone',$fournisseur->telephone ) }}" 
            ...
            <div class="mt-5 d-flex justify-content-end">
                ...
                <button type="submit" class="btn bg-gradient-primary-custom text-white rounded-3">
                    <i class="fa fa-user-edit me-1"></i> Modifier
                </button>
            </div>
        </form>
    </div>
