...
<div class="container-fluid">
    ...
    <!-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Service Médicaux</h1>
    ...
    <div class="row align-items-center mb-3">
        ...
        <div class="col-md-3 text-end">
            <a class="btn bg-gradient-primary-custom text-white btn-sm" href="{{ route ('service.create') }}">
        ...
        <div class=" row card-header ">
            ...
            <div class="col-md-6">
                <h1 class="mb-0 text-pr">
                    <i class="fas fa-briefcase-medical"></i> Service
                </h1>
            </div>
            <div class="card-body">
                    ...
                    <thead class="bg-primary text-white">
                        ...
                        <tbody>
                             <tr>
                                    ...
                                    <th>{{$se->type_service}}</th>
                                    <th>{{$se->tarif}}</th>
                                    <th>
                                       <a type="button" class="btn btn-sm btn-warning" href="/edit_service/{{$se->id}}/edit" >
                                            ...
                                            <div class="modal fade" id="staticBackdropdelete" data-bs-backdrop="static"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered ">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{route('service.delete', $se->id) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
